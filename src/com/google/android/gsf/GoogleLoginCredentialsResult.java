...
public class GoogleLoginCredentialsResult implements Parcelable {
	...
	public static final android.os.Parcelable.Creator<GoogleLoginCredentialsResult> CREATOR =
        new android.os.Parcelable.Creator<GoogleLoginCredentialsResult>() {
            @Override
	...
	public int describeContents() {
		return credentialsIntent == null ? 0 : credentialsIntent.describeContents();
	}
